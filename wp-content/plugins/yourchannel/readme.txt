=== YourChannel: Everything you want in a YouTube plugin. Seriously. ===
...
* Limit videos per load and total videos.
* Show content from any channel directly from shortcode.
* Sticky (Floating) Player.

= 0.9.3 =
* Implemented cache system to load faster and make less YouTube API calls.
* Added a new theme.
* Options to show single videos. Shortoode e.g: `[yourchannel video="C8WOH3eoCMw"]`
