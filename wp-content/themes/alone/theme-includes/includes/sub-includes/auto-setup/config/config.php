	...
	'demos' => array(
		...
		'alone-charitable' => array(
			array(
				'name'   => 'Bears Grid',
				'slug'   => 'bears-grid',
				'source' => 'http://theme.bearsthemes.com/plugin_install/bears-grid.zip'
			),
			array(
				'name' => 'Ninja Forms',
				'slug' => 'ninja-forms',
		...
		'alone-fundraising' => array(
			...
			array(
				'name'   => 'Bears Instagram',
				'slug'   => 'bears-scrapping-instagram-feed',
				'source' => 'http://theme.bearsthemes.com/plugin_install/bears-scrapping-instagram-feed.zip'
			),
		),
