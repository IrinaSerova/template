	...
	function _alone_filter_fw_ext_backups_demos($demos)
	{
		$demos_array = array(
			'alone-community-church' => array(
				...
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-community-church/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-community-church/',
			),
			'alone-fundraising' => array(
				'title' => esc_html__('Alone Fundraising', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-fundraising/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-fundraising/',
			),
			'alone-animal' => array(
				'title' => esc_html__('Alone Animal', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-animal/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-animal/',
			),
			'alone-candidate' => array(
				'title' => esc_html__('Alone Candidate', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-candidate/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-candidate/',
			),
			'alone-rescue' => array(
				'title' => esc_html__('Alone Rescue', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-rescue/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-rescue/',
			),
			'alone-give' => array(
				'title' => esc_html__('Alone Give', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-give/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-give/',
			),
			'alone-political' => array(
				'title' => esc_html__('Alone Political', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-political/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-political/',
			),
			'alone-foundation' => array(
				'title' => esc_html__('Alone Foundation', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-foundation/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-foundation/',
			),
			'alone-charity' => array(
				'title' => esc_html__('Alone Charity', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-charity/screenshot.png',
			...
			'alone-charitable' => array(
				...
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-charitable/screenshot.png',
			...
			'alone-childrents' => array(
				...
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-childrents/screenshot.png',
			...
			'alone-event-party' => array(
				...
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-event-party/screenshot.png',
			...
			'alone-organization' => array(
				...
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-organization/screenshot.png',
			...
			'alone-church-2' => array(
				...
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-church-2/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-church-2/',
			),
			'alone-church' => array(
				'title' => esc_html__('Alone Church', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-church/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-church/',
			),
			'alone-autism' => array(
				'title' => esc_html__('Alone Autism', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-autism/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-autismdemo/',
			),
			'alone-ngo' => array(
				'title' => esc_html__('Alone - NGO', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-ngo/screenshot.png',
				'preview_link' => 'http://theme.bearsthemes.com/wordpress/alone-ngo/',
			),
			'alone-5' => array(
				'title' => esc_html__('Alone 5', 'alone'),
				'screenshot' => 'http://theme.bearsthemes.com/import_demo/alone_theme/alone-5/screenshot.png',
		...
		foreach ($demos_array as $id => $data) {
			$demo = new FW_Ext_Backups_Demo($id, 'piecemeal', array(
				'url' => 'http://theme.bearsthemes.com/import_demo/alone_theme/',
				'file_id' => $id,
			));
